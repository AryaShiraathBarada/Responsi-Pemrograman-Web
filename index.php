...
<head>
	...
	<title>Responsi 2100018001</title>
...
<body>
	...
	<header>
		<div class="container" id="home">
			<h1><a href="index.php">ARYA SHIRAATH BARADA</a></h1>
			<ul>
				<li class="active"><a href="#home">HOME</a></li>
				<li><a href="#datamhs">DATA NILAI MAHASISWA</a></li>
	...
	<section class="about" id="datamhs">
		<div class="container">
	...
	<section class="about" id="calculator">
		<div class="container">
			<h3>CALCULATOR</h3>
		</div>
	</section>
	...
	<section class="about" id="calendar">
		<div class="container">
			<h3>CALENDAR</h3>
		</div>
	</section>
